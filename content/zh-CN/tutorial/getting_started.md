...
此外，您还可以更进一步的Beta-Release 您的产品原型或是变更你的个人档案。


# Beta-Release 产品原型
当您的产品原型已经过充分的测试且准备少量发行给外部使用者做测试时，您可以在Mediatek Cloud Sandbox 上Beta-Release 您的产品原型。

欲了解更多有关Beta-Release 的介绍，请参考教程文件[这里](./beta-release).
