...
为了能够利用此 API 来取得使用者 acces token，您需要先在 MCS 网站先申请 AppId 和 AppSecret。您可以在用戶設定頁面中的第三方服務專區，申請取得此兩項資訊。您需要注意，user token 每两周将会过期。
...
当您取得 AppId 和 AppSecret 之后，您需要使用 64 base 加密此字串：`appId:appSecret`
